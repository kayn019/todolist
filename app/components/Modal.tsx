...
const Modal = ({ isOpen, onClose, handleAddProject, inputValue, setInputValue }) => {
       ...
       <div className="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md p-5">
           <form onSubmit={handleAddProject}>
              ...
              <div className='modal-action'>
                ...
                />
                <button type='submit' className='btn bg-green-500 hover:bg-green-600 py-1 px-2 mr-2 rounded-sm font-medium'>
                  Submit
                </button>
                <button type='reset' className='btn bg-red-500 hover:bg-red-600 py-1 px-2 rounded-sm font-medium' onClick={onClose}>
                  Cancel
                </button>
              </div>
            </form>
